<%@page import="com.example.controller.Controller"%>
...
<link rel="preconnect" href="https://fonts.gstatic.com">
  ...
  <a href="index.jsp?category=<%= c.getCategoryId()%>" class="list-group-item list-group-item-action"><%= c.getCategoryTitle()%></a>
       ...
       <img src="images/medicine_img/<%= p.getpPhoto()%>" style="max-height: 120px;max-width: 90%;width: auto; " class="card-img-top m-2" alt="...">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <p class="card-text">
                                            <%= Controller.get10Words(p.getpDesc())%>
